...
public class TMView extends JInternalFrame implements ChangeListener {
    ...
    private Vector<ReversibleAction> undoableActions = new Vector<ReversibleAction>();
    private Vector<ReversibleAction> redoableActions = new Vector<ReversibleAction>();
