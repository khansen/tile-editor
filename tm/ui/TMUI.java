...
//    private JMenuItem exportPaletteMenuItem = new JMenuItem("Export...");  // tpl, c, asm, java?
    ...
    private Hashtable<TileCodec, TileCodecMenuItem> tileCodecButtonHashtable = new Hashtable<TileCodec, TileCodecMenuItem>();
    private Hashtable<ColorCodec, ColorCodecMenuItem> colorCodecButtonHashtable = new Hashtable<ColorCodec, ColorCodecMenuItem>();
    private Hashtable<TMPalette, PaletteMenuItem> paletteButtonHashtable = new Hashtable<TMPalette, PaletteMenuItem>();
